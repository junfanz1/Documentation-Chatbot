...
def ingest_docs():
    loader = ReadTheDocsLoader("langchain-docs/langchain-docs 2/api.python.langchain.com/en/latest")
    ...
    print(f"Going to add {len(documents)} to Pinecone vector store")
